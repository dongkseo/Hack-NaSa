...
#     """행동 결정 결과"""
#     speaker_action: str = None  # "media_play_pause", "media_next", "stop", None
...
#             # if speaker_action == "media_play_pause":
#             #     await speaker_controller.media_play_pause()
#             #     actions_taken.append("speaker:alert")
#             # elif speaker_action == "media_next":
#             #     await speaker_controller.media_next()
...
#         Args:
#             action_id: 행동 ID
#             speaker_action: 스피커 동작 ("media_play_pause", "media_next", None)
